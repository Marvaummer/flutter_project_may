...
class MovieProvider extends ChangeNotifier{
  ...
  final List<Movie> _movies = movieList;//movies are private variable it access in getter
  ...
  void addToList(Movie moviefromMain){
    ...
    notifyListeners();// object changes, to notify any clients the object may have changed
  }
